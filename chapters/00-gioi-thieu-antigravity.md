...
![Tổng quan Hệ sinh thái Agentic AI cho Doanh nghiệp](images/premium_agentic_ai_overview_sme.png)

---

## 0.1. Bảng Tiêu Chuẩn Giới Hạn Của Chương

> [!NOTE]
> Mọi chương sách trong Ebook này đều tuân thủ khắt khe 7 Hạng mục Thực chiến để ép người đọc phải hành động.

- **🎯 [Mục Tiêu Chương] (Objective):** Đập nát tư duy "Mua AI về để Chat". Giúp Sếp hiểu rõ định nghĩa Agentic AI (Trí tuệ Nhân tạo Dạng Đặc Vụ) và cài đặt thành công Antigravity trong 10 phút.
- **📥 [Đầu Vào] (Input):** Máy tính nối mạng, tài khoản Google, và tư duy sẵn sàng gỡ bỏ hoàn toàn quy trình làm việc cũ.
- **🚀 [Đầu Ra] (Output):** Sở hữu một "Nhân Sự Số" nằm ngay trong ổ cứng máy tính, biết tự lướt web, tự code, tự đọc file Excel.

---

## 0.2. Lời Mở Đầu: Đừng Bị Mê Hoặc Bởi Những Chatbot "Không Chân Không Tay"
...
> [!IMPORTANT]
> **[Phân Tích Cập Nhật 2025] Báo Cáo Gartner & McKinsey Sự Dịch Chuyển:**
> Theo báo cáo *The State of AI 2025* của McKinsey, 98% công ty SME toàn cầu đã sử dụng AI, nhưng **72% thất bại trong việc thu hồi vốn (ROI)** vì họ chỉ dùng AI ở dạng "Tạo Sinh Văn Bản" (Chatbot). Trong khi đó, nhóm 15% doanh nghiệp tăng trưởng gấp ba lần lợi nhuận đều đang dồn vốn chuyển dịch sang **Agentic AI** (Trí tuệ Nhân tạo có khả năng tự chủ hành động). Kỷ nguyên ngồi hỏi ChatGPT tốn 10 phút đã chết. 2025 là năm của Lệnh Thực Thi tự động.
...
## 0.3. 🩺 Bài Test Sẵn Sàng AI: Công Ty Bạn Có Đủ "Sức Khỏe" Để Tiếp Nhận Antigravity?

![Bài Test Sẵn Sàng AI — 10 tiêu chí tự chấm điểm sức khỏe số doanh nghiệp](images/ai_readiness_test.png)

> [!TIP]
> **Hướng dẫn làm bài test:** Trước khi lao vào 18 chương tiếp theo, hãy dành ĐÚNG 3 PHÚT làm bài tự chấm điểm này. Vòng tròn đáp án, cộng tổng điểm và đọc kết quả bên dưới. Nếu dưới 40 điểm — hãy dừng lại, chữa bệnh nền đã.
...
## 0.4. Antigravity Là Gì? Kỷ Nguyên Của "Agentic AI" (Đại Lý Tự Trị)
...
## 3.1. Antigravity Trông Như Thế Nào? (Tour Giao Diện Trực Quan)
...
![Chat Panel — nơi bạn ra lệnh và AI báo cáo kết quả](images/chat_panel_detail.png)
...
![Terminal tự động chạy code — phát hiện 7 giao dịch bất thường](images/terminal_running_code.png)

### 🔄 Quy Trình Vận Hành Tổng Thể

Toàn bộ quy trình từ lúc bạn ra lệnh đến khi có kết quả, tóm gọn như sau:

![Antigravity Workflow — Từ mệnh lệnh đến kết quả tự động](images/antigravity_workflow.png)
...
## 0.5. [Cách Làm Chi Tiết & Hướng Dẫn Kỹ Thuật] Cài Đặt Khởi Động Antigravity Trong 10 Phút

> [!CAUTION]
> Toàn bộ quá trình cài đặt chỉ cần làm 1 LẦN DUY NHẤT. Sau đó mỗi ngày mở lên là dùng.

### 👣 Quy trình 3 bước "Cầm tay chỉ việc"

**Bước 1: Truy Cập Trang Chủ & Kích Hoạt**

- 🌐 Mở trình duyệt, truy cập: **<https://antigravity.google>**
- ⚡ Bấm nút **"Get Started"** (Bắt đầu).
- 🔑 Đăng nhập bằng **Tài khoản Google** cá nhân hoặc doanh nghiệp.

**Bước 2: Khởi Tạo Không Gian Làm Việc (Workspace)**

- 📁 Tại màn hình Dashboard, chọn **"New Workspace"**.
- ✏️ Đặt tên ngắn gọn (Ví dụ: `Antigravity_SME`).
- 📂 Kéo thả toàn bộ thư mục chứa file PDF/Excel/Data của bạn vào vùng chứa.

**Bước 3: Giao Tiếp & Ra Lệnh**

- 💬 Nhìn sang Panel Chat bên phải.
- ⌨️ Gõ thử: *"Hãy liệt kê cấu trúc file trong workspace này cho tôi"*.
- 🚀 AI sẽ tự động rà quét và hiển thị toàn bộ danh sách file ngay lập tức.

> [!TIP]
> **Về cấu hình nâng cao:** Nếu sếp muốn dùng các Model "khủng" như Gemini 1.5 Pro hoặc Claude 3.5 Opus, hãy xem hướng dẫn tại [Chương 17 — ROAI](02-do-luong-roai.md) và [Phụ Lục Cài Đặt](phu-luc-cai-dat-moi-truong.md).

---

## 0.6. [Ví Dụ Mẫu & Case Study] Thực Hành Lệnh Cơ Bản & Sudo Prompt Đầu Tiên
...
### 0.7. [Kết Quả Đầu Ra & Processing] — AI Sẽ Trả Lời Gì?
...
| AI trả kết quả sai hoặc "ảo giác" (Hallucination) | Prompt chưa đủ ràng buộc, AI tự suy diễn số liệu. | Thêm Hàng Rào Tử Hình: *"Cấm đoán mọi hành vi đoán mò (Guess). Nếu cột trống, ghi rõ NULL."* Xem chi tiết ở [Chương 17: Bảo Mật](10-bao-mat.md). |
...
| 2 | **Opus không nuốt được file lớn** | Ném file Excel 50MB cho Opus → lỗi tràn bộ nhớ. | File lớn phải dùng **Gemini 3.1 Pro** (Context Window 1-2 triệu Token). Xem [Chương 16](03-mo-hinh-ai-quyen-luc.md). |
...
| 6 | **Phụ thuộc Quota API** | Dùng gói Free thì giới hạn 15-50 request/ngày, rất nhanh hết. | Dùng gói Vertex AI Pay-as-you-go hoặc Anthropic API. Xem bảng Quota ở [Chương 16](03-mo-hinh-ai-quyen-luc.md). |
...
1. **Xây dựng Kho Tri Thức Tổ Chức (Knowledge Management):** Mỗi quy trình nghiệp vụ được đóng gói thành Skill `.md` → nhân sự mới vào công ty chỉ cần gõ lệnh, không cần ai đào tạo. *(Xem chi tiết: [Chương 17 — Skills & Workflows](07-skills-va-workflows.md))*
...
5. **Ra Quyết Định Dựa Trên Data (Data-Driven Decision):** Thay vì tranh cãi bằng cảm tính, CEO ném câu hỏi chiến lược cho AI mô phỏng kịch bản Monte Carlo. *(Xem: [Chương 17 — Ra Quyết Định](12-business-decision-making.md), [Skill Phân Tích Quyết Định](../skills/phan_tich_quyet_dinh/SKILL.md))*

---

## 0.8. [Kết Luận & Action Items] Checklist Kích Hoạt Tư Duy Sáng Hôm Sau
...
- [Chương 17 — So sánh Gemini vs Opus](03-mo-hinh-ai-quyen-luc.md)
